...
RAW_ROOT = DATA_DIR / "raw"                # dữ liệu gốc, mỗi dataset một thư mục con
PROCESSED_DIR = DATA_DIR / "processed"     # dữ liệu đã qua pipeline
REPORT_DIR = DATA_DIR / "reports"
EDA_REPORT_DIR = REPORT_DIR / "eda"
PIPELINE_REPORT_DIR = REPORT_DIR / "pipeline"
MODEL_INPUT_REPORT_DIR = REPORT_DIR / "model_input"   # phép đo input thật (pha 3)
MODEL_EVAL_REPORT_DIR = REPORT_DIR / "model_eval"     # chạy model + chấm điểm (pha 4)
ASSETS_DIR = REPORT_DIR / "assets"         # tài nguyên dùng chung (plotly.min.js)
MODEL_ASSETS_DIR = DATA_DIR / "models"     # tài nguyên của model (vd: model VnCoreNLP)

CONFIG_DIR = ROOT_DIR / "configs"
DATASET_CONFIG_DIR = CONFIG_DIR / "datasets"
PIPELINE_CONFIG_PATH = CONFIG_DIR / "pipeline.yaml"
MODEL_CONFIG_DIR = CONFIG_DIR / "models"   # "model đọc dữ liệu thế nào" (pha 3)
PROMPT_DIR = CONFIG_DIR / "prompts"        # nội dung prompt, mỗi prompt một file .txt
