...
2. `docs/00_workflow/04_terms.md` để hiểu thuật ngữ.
3. `docs/05_config/*` để biết mỗi tệp cấu hình chứa gì.
...
| Nhóm | Tệp | Nội dung | Đọc khi nào |
|---|---|---|---|
| 00_workflow | `01_flow.md` | luồng làm việc từ tạo thí nghiệm tới thu kết quả | mới vào nhóm |
| 00_workflow | `02_rules.md` | luật bắt buộc: nhánh, ghim code, resume, bí mật | trước khi chạy hoặc giao thí nghiệm |
| 00_workflow | `03_ci.md` | CI kiểm gì, CI không làm gì, cách sửa khi đỏ | khi CI báo đỏ |
| 00_workflow | `04_terms.md` | thuật ngữ và phân biệt hai loại preprocessing | khi gặp từ không rõ |
| 00_workflow | `05_git_commits.md` | quy ước commit và cách chia nhỏ task | trước khi commit |
| 00_workflow | `06_conventions.md` | quy ước code, cấu hình, tài liệu | khi viết mới |
| 01_dataset | `01_raw_data.md` | dữ liệu gốc: tệp, encoding, ý nghĩa | làm việc với dữ liệu gốc |
| 01_dataset | `02_schema.md` | schema của dữ liệu | khi đọc hoặc sửa schema |
| 01_dataset | `03_new_dataset.md` | cách thêm dataset mới | khi có dữ liệu mới |
| 02_eda | `01_flow.md` | luồng EDA và công tắc đang áp dụng | chạy EDA |
| 02_eda | `02_metrics.md` | cách tính từng chỉ số EDA | đọc kết quả EDA |
| 02_eda | `03_modules.md` | chi tiết 5 module EDA | sửa EDA |
| 02_eda | `04_report_rules.md` | quy ước trình bày báo cáo | sinh báo cáo |
| 02_eda | `05_extend.md` | thêm bước EDA mới | mở rộng EDA |
| 03_pipeline | `01_flow.md` | luồng 7 bước và cấu hình bật tắt | chạy pipeline |
| 03_pipeline | `02_steps.md` | chi tiết từng bước | sửa một bước |
| 03_pipeline | `03_config.md` | cấu hình pipeline | đổi cấu hình |
...
| 04_experiments | `02_phase3_input.md` | đo đầu vào thật của model | chọn `max_length` |
...
| 04_experiments | `metrics.md` | định nghĩa từng chỉ số đánh giá | viết báo cáo |
...
| 05_config | `02_pipeline.md` | cấu hình xử lý dữ liệu | sửa cách làm sạch |
| 05_config | `03_datasets.md` | cấu hình dataset và schema | thêm hoặc sửa dataset |
| 05_config | `04_models.md` | cấu hình dùng chung cho model | thêm hoặc sửa model |
| 05_config | `05_experiments_shared.md` | cấu hình dùng chung cho thí nghiệm | đổi cách chấm hoặc huấn luyện |
| 05_config | `06_experiment.md` | cấu hình riêng của thí nghiệm | tạo thí nghiệm |
| 05_config | `07_env.md` | biến môi trường và tệp env | cấu hình máy hoặc Colab |
| 06_plan | `README.md` | mục lục kế hoạch và trạng thái từng phase | hằng ngày |
| 06_plan | `P0..P7` | việc nhỏ của từng phase kèm commit | khi triển khai |
