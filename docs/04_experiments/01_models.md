...
Tài liệu pha 3–4 (chuẩn bị input cho từng model, huấn luyện và đánh giá) chỉ bắt đầu
...
`--segmenter <tên>`, mặc định là bộ chính chủ RDRSegmenter/VnCoreNLP. Tách từ ≠ tokenizer,
nên đổi bộ tách từ không kéo theo việc đổi tokenizer — nhờ vậy câu hỏi "tách từ giúp bao
nhiêu" trả lời được bằng số đo (xem [02_phase3_input.md §3](02_phase3_input.md)).
...
nằm ở `src/preprocessing/` — xem [02_phase3_input.md](02_phase3_input.md).

---

Xem tiếp: [02_phase3_input.md](02_phase3_input.md) — chuẩn bị input và đo token thật;
