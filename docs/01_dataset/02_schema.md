...
trong `configs/datasets/cosmetics.yaml`:
...
Quyết định này được khai báo tại `configs/datasets/cosmetics.yaml`
...
> [02_eda/02_metrics.md](../02_eda/02_metrics.md) §11 để biết báo cáo trình bày nhóm
> này thế nào và [03_pipeline/02_steps.md](../03_pipeline/02_steps.md) §5 để biết
...
> Đây là *null*, một trạng thái riêng biệt.
