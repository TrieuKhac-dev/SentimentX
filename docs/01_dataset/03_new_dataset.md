...
2. Copy `configs/datasets/cosmetics.yaml` thành `configs/datasets/<tên>.yaml`
...
Sau khi thêm dataset, chạy đủ ba pha theo đúng thứ tự: EDA (khảo sát) → pipeline
(xử lý) → thực nghiệm. Cách chạy từng pha: [02_eda/01_flow.md](../02_eda/01_flow.md) §4
và [03_pipeline/01_flow.md](../03_pipeline/01_flow.md) §5.
