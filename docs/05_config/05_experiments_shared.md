...
Năm tệp trong `configs/experiments/`. Chúng hợp nhất với nhau và với cấu hình riêng của thí nghiệm.
...
| `artifacts` | danh sách tệp nhỏ được tải lên; không tải checkpoint |
