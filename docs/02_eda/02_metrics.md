...
theo tokenizer riêng, và độ dài input thật được đo riêng ở tiền xử lý cho model bằng
`run_token_stats.py` (xem [02_model_input.md mục 2](../04_experiments/02_model_input.md)).
...
chọn một nhãn (xem [03_pipeline/02_steps.md mục 3](../03_pipeline/02_steps.md)).
