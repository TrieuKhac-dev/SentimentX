...
Cách đọc p50/p95/p99: [02_metrics.md §1](02_metrics.md).
...
là số review có nhãn) — xem [02_metrics.md §11](02_metrics.md). Ma trận xuất hiện
...
cho từng nhóm ([02_metrics.md §3](02_metrics.md)) và **quy mô từng quy tắc gắn cờ**
teencode ([02_metrics.md §8](02_metrics.md)).
...
đúng như pipeline ([02_metrics.md §5](02_metrics.md)). Cách phát hiện từng nhóm nhiễu:
[02_metrics.md](02_metrics.md) §4 (gibberish), §5 (khoá so trùng), §6 (ký tự lặp), §7
(quảng cáo và code), §8 (teencode). Không còn nhóm "có dấu hiệu nhận xu" — đã bỏ
khỏi dự án.
...
([03_pipeline/02_steps.md §3](../03_pipeline/02_steps.md)).
...
Cách đếm từng chỉ số ở [02_metrics.md](02_metrics.md) §9 (từ vựng, số từ / review) và
§10 (cụm 2 từ). Hai điểm đã sửa cho dễ đọc:
...
([02_metrics.md §12](02_metrics.md)). Xung đột nhãn có hai mức đếm là review và ô nhãn
([02_metrics.md §13](02_metrics.md)); danh sách xung đột trên báo cáo là **đầy đủ,
không cắt bớt**.
