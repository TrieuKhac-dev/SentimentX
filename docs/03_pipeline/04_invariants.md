...
[02_eda/02_metrics.md §5](../02_eda/02_metrics.md) — bỏ dấu chỉ loại thêm 5 dòng
...
`configs/pipeline.yaml` **không có** công tắc nào cho việc đó — tìm chữ "teencode"
...
([§2](#2-văn-bản-không-mất-dấu-tiếng-việt) của file này).

---

Xem thêm: [02_steps.md §4](02_steps.md) — chi tiết bốn phép chuẩn hoá;
[02_eda/02_metrics.md §8](../02_eda/02_metrics.md) — vì sao teencode chỉ được đo.
